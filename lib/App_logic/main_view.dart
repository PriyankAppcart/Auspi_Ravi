...
import 'package:auspi_ravi_flutter/App_logic/sectetion_list.dart';
import 'package:auspi_ravi_flutter/RemoteServices/cust_text_center.dart';
import 'package:auspi_ravi_flutter/SizeConfig.dart';
import 'package:auspi_ravi_flutter/cust_text.dart';
import 'package:auspi_ravi_flutter/photosViewPage.dart';
...
class MainView extends StatelessWidget {
  ...
  return controller.City.isNotEmpty &&
      ...
      controller.Planet_isRetro.isNotEmpty &&
      controller.current_Time.isNotEmpty &&
      ...
      body: GetBuilder<app_logic_controller>(
        ...
        builder: (controller) => Container(
          decoration: BoxDecoration(
            color: !controller.internetConnection ||
                    !controller.enableDeviceLocation ||
                    !isDataLoaded(controller)
                ? Colors.white
                : null,
            gradient: controller.internetConnection &&
                    controller.enableDeviceLocation &&
                    isDataLoaded(controller)
                ? LinearGradient(
                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) =>
                                    ...
                                    onSelected: (city, lat, long) {
                                      ...
                                      controller.getLocationPreset(lat, long);
                                    },
                                  ),
                                );
                              },
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      auspiSevenData(
                                        ...
                                        "${controller.graha} \n(Starts:${controller.Hora_start}) \n(Ends:${controller.Hora_end})",
                                      ),
                                      SizedBox(
                                          height:
  ...
  children: <Widget>[
    GestureDetector(
      onTap: () {
        Get.to(() => WidgetViewPage(dialType: 'planet_position'));
      },
      child: Center(
        child: Padding(
          padding: EdgeInsets.only(
            left: 2 * (MediaQuery.of(context).size.width / 100),
            right: 2 * (MediaQuery.of(context).size.width / 100),
          ),
    ...
    GestureDetector(
      onTap: () {
        Get.to(() => WidgetViewPage(dialType: 'sevenday_dial'));
      },
      child: Center(
        child: Padding(
          padding: EdgeInsets.only(
  ...
  Widget auspiSevenData(
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: logicController.isDarkMode
          ...
          children: [
            Expanded(
              ...
              child: CustText(
                name: title,
                size: 1.6,
                colors: logicController.isDarkMode
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            Transform.rotate(
              angle:
                  ((double.parse("${logicController.Solar_deg_new}")) * pi) /
                      180,
              child: Center(
...
//                     child: Row(
//                       children: [
//                         CustText(name: "Auspi Ravi ",size: 2,colors:Colors.white,fontWeightName:FontWeight.w600),
//                       ],
//                     ),
//                   ),
//                 ),
...
//           child: Center(child: Image.asset("assets/sun.png",fit: BoxFit.fitHeight)),
//         ),
